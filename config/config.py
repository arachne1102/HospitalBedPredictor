...
class Config:
    ...
    # 모델 파일 경로 설정
    LINEAR_REGRESSION_MODEL_PATH = get_env_variable("LINEAR_REGRESSION_MODEL_PATH")
    LSTM_MODEL_PATH = get_env_variable("LSTM_MODEL_PATH")
    LSTM_SCALER_PATH = get_env_variable("LSTM_SCALER_PATH")

    # 예측 결과 파일 경로 설정
    LINEAR_REGRESSION_PREDICTIONS_PATH = get_env_variable("LINEAR_REGRESSION_PREDICTIONS_PATH")
